...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "03ce83e6-a786-4559-a5d3-bd1bd8230104");
  ...
  return (
    <div className='contact'>
      <div className="contact-col">
        <h3>Send us a message <img src={msg_icon} alt="" className="src" /></h3>
        ...
        <ul>
          <li><img src={mail_icon} alt="" />ContactUjjwal@gmail.com </li>
